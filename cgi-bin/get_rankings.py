#!/usr/bin/env python3
"""
Create web page for rankings of combatants stored in the data base
"""
...
def get_data():
    ...
    sql = ("SELECT SUM(id) AS id, Name, SUM(wins) AS Wins "
           "FROM (SELECT id, Name, 0 AS wins "
    ...
    print("<tr><td style='text-align:center;'>"
          "<b>Combatant</b></td><td>Wins</td></tr>")
    for item in data:
